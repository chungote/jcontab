 ...
 * @author jacg
 */
public final class Contab_1 extends javax.swing.JFrame {
    //Variables
    int temp  = 0;
...
@Override
    ...
    private void initComponents() {
        ...
        imprimirFacturaButton.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        imprimirFacturaButton.setVerticalTextPosition(javax.swing.SwingConstants.BOTTOM);
    ...
    private void imprimirFacturaButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imprimirFacturaButtonActionPerformed
        ...
        if(!totalTxt.getText().isEmpty()){
            ...
            String filename = System.getProperty("user.home") + "/DesktopManager/ImpresionFactura.jasper";
